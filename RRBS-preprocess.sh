...
for ((i=0;i<=${#file1[@]};i++)); do
bismark /home/songjia/reference/hg19 bowtie2 -quiet -o ./cleandata/alignment_result_bowtie2/ --multicore 8 --temp_dir ./cleandata/alignment_result_bowtie2/tmp /home/songjia/reference/hg19 -1 ${file1[i]} -2 ${file2[i]}
done
