...
print('figure draw start!')
input_file = out_dir+'anno_noIndex_'+file_name+date+'result.csv'
path = out_dir+file_name
os.system('''rrun draw_gene_region.R -i {} -o {}'''.format(input_file, path))
sp = subprocess.Popen(["/bin/bash", "-i", "-c", "rrun draw_gene_region.R -i {} -o {}".format(input_file, path)])
sp.communicate()
print('Draw confirmed!')
#############################################
#################都是shi######################